  ...
  const projects = [
    {
      ...
      image: "https://i.postimg.cc/L626j8Zf/Screenshot-2025-04-06-194635.png",
      tags: ["React", "Node.js", "mongodb ", "Redux","Express Js","GitHub","Git"],
      github: "https://github.com/MUKESHKUSHWAHA41866/BOOK-STORE-WITH-ADMIN",
      demo: "https://github.com/MUKESHKUSHWAHA41866/BOOK-STORE-WITH-ADMIN",
      details: {
        overview: "A full-stack e-commerce solution built with modern technologies, An E-commerce platform with 2 panels User, Admin panels. Users can browse, add to cart,and purchase and admins manage products and inventory.• Built with React.js, Node.js, Express.js, and MongoDB, offering responsive design and it has 2 role-based access control",
        features: [
          "User authentication and authorization",
          "Book catalog with advanced filtering",
    ...
    },
    {
      ...
      github: "https://github.com/MUKESHKUSHWAHA41866/episode-12-react.js",
    ...
    },
    {
      ...
      github: "https://github.com/MUKESHKUSHWAHA41866/episode-16",
