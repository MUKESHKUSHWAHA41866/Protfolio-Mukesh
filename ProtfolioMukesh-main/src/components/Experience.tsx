...
export const Experience = () => {
  ...
  const experiences = [
    ...
    // },
    {
      ...
      description:
        "Developed and maintained Frontend applications using React,Nextjs and improved application performance by 40%. Also worked on chatapp intigration and job Recruter website.",
      skills: ["React","Nextjs", "JavaScript", "Tailwind CSS", "Shadcn", ],
    },
    // {
    //   title: "Web Developer",
    //   company: "Jagruti Rehabilitation Centre",
